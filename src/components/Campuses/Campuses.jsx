...
//             <span
//               key={index}
//               className="absolute text-[#d79a29] font-bold text-4xl"
//               style={{
//                 transform: `rotate(${
...
const Campuses = () => {
  ...
  const clipScroll = Math.max(0, (scrollY - 550) * 3.5);
  ...
  const parallax = useParallax({
    rotate: [0, 360],
    disabled: window.innerWidth < 768, // Disable parallax for mobile
  });
